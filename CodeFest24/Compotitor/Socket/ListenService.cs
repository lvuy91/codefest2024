...
{ 
    ...
    {
        private static RegisterPlayerDto _player = new RegisterPlayerDto();
        private static UserDto _user = new UserDto();
        ...
        private static CompotitorService service = new CompotitorService();
